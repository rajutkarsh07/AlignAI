  ...
  return (
    <div className="space-y-6">
      <div className="card">
        ...
        <div className="mt-6">
          <h2 className="text-lg font-medium text-secondary-900 mb-4">Project Plan</h2>
          <div className="prose prose-sm max-w-none">
            {project.formattedPlan ? (
              <div dangerouslySetInnerHTML={{ __html: project.formattedPlan.replace(/\n/g, '<br>') }} />
            ) : (
        ...
        {project.goals && project.goals.length > 0 && (
          <div className="mt-6">
            <h2 className="text-lg font-medium text-secondary-900 mb-4">Goals</h2>
            <div className="space-y-3">
              {project.goals.map((goal: any) => (
                <div key={goal._id} className="p-4 border border-secondary-200 rounded-lg">
