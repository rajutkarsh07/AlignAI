...
console.log(
  '🚀 Setting up AlignAI - AI-Powered Product Management Platform...\n'
);
...
// Create directories
const directories = ['uploads/projects', 'uploads/feedback', 'logs'];
...
console.log(
  '2. Set up Google Cloud Vertex AI and download service account key'
);
